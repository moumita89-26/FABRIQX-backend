...
router.register("account/reviews", views.CustomerReviewViewSet, basename="customer-review")
...
urlpatterns = [
    ...
    path("homepage/banners/", views.HomepageBannerListView.as_view(), name="api-homepage-banners"),
    path("homepage/categories/", views.HomepageCategoryListView.as_view(), name="api-homepage-categories"),
    path("homepage/products/", views.HomepageProductCollectionView.as_view(), name="api-homepage-products"),
    path("homepage/offers/", views.HomepageOffersView.as_view(), name="api-homepage-offers"),
    path("homepage/brands/", views.HomepageBrandListView.as_view(), name="api-homepage-brands"),
    path("homepage/footer-social/", views.FooterSocialLinksView.as_view(), name="api-footer-social-links"),
    path("homepage/content/", views.HomepageContentView.as_view(), name="api-homepage-content"),
    path("navigation/", views.NavigationView.as_view(), name="api-navigation"),
    path("categories/<slug:slug>/subcategories/", views.SubcategoryListView.as_view(), name="api-subcategory-list"),
    ...
    path("contact/", views.ContactSubmissionView.as_view(), name="api-contact-submission"),
    path("account/profile/", views.ProfileView.as_view(), name="api-profile"),
    path("account/dashboard/", views.CustomerDashboardView.as_view(), name="api-customer-dashboard"),
    path("account/coupons/", views.CustomerCouponListView.as_view(), name="api-customer-coupons"),
